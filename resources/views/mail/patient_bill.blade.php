                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="padding: 30px">
                                                <p>Hi Dr. {{ $appointment->user->first_name }}! <br><br>

                                                You have a new scheduled appointment on {{ $appointment->schedule }} with {{ $appointment->patient->fullname }}. <br><br>

                                                Complaint: {{ $appointment->complaints }} <br><br>
                                                Schedule: {{ $appointment->schedule }} <br><br>
